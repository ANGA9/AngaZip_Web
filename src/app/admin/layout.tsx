...
import { LayoutDashboard, Users, LogOut, ShieldCheck, Loader2, Bell, UserMinus, MessageSquareX, Award, Tag } from "lucide-react";
    ...
    <div className="admin-layout">
      <aside className="admin-sidebar">
        ...
        <nav className="admin-sidebar-nav">
          ...
          <Link
            href="/admin/promos"
            className={`admin-nav-item ${pathname.startsWith("/admin/promos") ? "active" : ""}`}
          >
            <Tag /> Promo Codes
          </Link>
          {/* Phase 2:
